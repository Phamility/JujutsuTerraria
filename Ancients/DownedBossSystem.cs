...
namespace TenShadows.Ancients
{
    ...
    {
        public static bool downedNue = false;
        ...
        {
            downedNue = tag.ContainsKey("downedNue");
            AmPlaced = tag.GetBool("AmPlaced");

            if (AmPlaced == true)
            {
                BindingVowTile.AmPlaced = true;
            }
            if (AmPlaced == false)
            {
                BindingVowTile.AmPlaced = false;
