...
namespace JujutsuTerraria.Ancients
{
    ...
    public class ModIntegrationsSystem2 : ModSystem
    {
        ...
        private void DoBossChecklistIntegration()
        {
            ...
            int spawnItem = ModContent.ItemType<NueSummon>();

            // "collectibles" like relic, trophy, mask, pet
            List<int> collectibles = new List<int>()
            {
                ModContent.ItemType<Tiles.TrophyItem>(),
            ...
            var customPortrait = (SpriteBatch sb, Rectangle rect, Color color) => {
                Texture2D texture = ModContent.Request<Texture2D>("JujutsuTerraria/NPCS/Nue_Preview").Value;
