...
namespace JujutsuTerraria.Projectiles
{
    ...
    public class DogSummon : ModProjectile
    {
        public static bool KYS = false;
        ...
        public override void AI()
        {
            ...
            if (KYS == true)
            {
                ...
                Projectile.NewProjectileDirect(Projectile.GetSource_FromThis(), player.position, player.velocity, ModContent.ProjectileType<DogSummon>(), DivineDog.MYDAMAGE, 2, player.whoAmI);
                KYS = false;
                Task.Delay(1);
